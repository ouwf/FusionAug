...
def get_transforms(dataset, img_size, data_aug=True):
    # normalize to [-1, 1]
    ...
    if data_aug:
        if dataset.lower() == 'fvusm':
            ...
            transform_train.append(transforms.RandomResizedCrop(size=img_size, scale=(0.5, 1.0), ratio=(img_ratio, img_ratio)))
